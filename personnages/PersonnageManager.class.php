...
class PersonnageManager {
	...
	public function getPersonnageById($id) {
		$getPersonnageQuery = $this->getPdo ()->prepare ( 'SELECT ID, NOM, EXPERIENCE, LOCALISATION, NIVEAU, FORCEPERSO, DEGATS FROM PERSONNAGES WHERE ID=:id' );
		$getPersonnageQuery->bindValue ( ':id', $id );
		$getPersonnageQuery->execute ();
		$perso = new Personnage ();
		$perso->hydrate ( $getPersonnageQuery->fetch ( PDO::FETCH_ASSOC ) );
		return $perso;
	}
