...
if (isset ( $ajouter )) {
	...
	if (is_null ( $nom ) || is_null ( $experience ) || is_null ( $location ) || is_null ( $degats ) || is_null ( $forceperso ) || is_null ( $niveau )) {
...
<html>
	<head></head>
	<body>
	<a href="./newexe.php">Accueil</a>
	<h1>Ma page de site</h1>
	<h2><?php
	
	echo $message?></h2>
		<form action="newexe.php" method="get">
